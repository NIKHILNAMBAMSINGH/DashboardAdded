<%@ Page Title="" Language="C#" MasterPageFile="~/LeaveAdmin.master" AutoEventWireup="true" CodeFile="LeavePendingAdmin.aspx.cs" Inherits="LeavePendingAdmin" %>
                ...
                <table class="auto-style1" style="height: 335px">
                    ...
                    <tr>
                        <td style="vertical-align: top">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="LeaveId" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCommand="GridView1_RowCommand" EmptyDataText="No data found" ShowHeaderWhenEmpty="true">
    <Columns>
        <asp:BoundField DataField="LeaveId" HeaderText="LeaveId" ReadOnly="true" />
        <asp:BoundField DataField="EmpName" HeaderText="Empployee Name" ReadOnly="true" />
