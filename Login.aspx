                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block">
                                    <asp:Image ID="LoginImage" runat="server" CssClass="login-image" ImageUrl="~/Images/Picasoid.png" Width="100%"/>
                                </div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <asp:Button ID="LoginButton" runat="server" Text="Login" CssClass="btn btn-primary btn-user btn-block" OnClick="LoginButton_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
