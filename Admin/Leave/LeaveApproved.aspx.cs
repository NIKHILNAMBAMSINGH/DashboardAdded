...
public partial class Admin_Leave_LeaveApproved : System.Web.UI.Page
{
    ...
    protected void BtnSearchLeave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string query = "SELECT e.EmpId as EmpId, l.LeaveId as LeaveId, CONCAT(e.FirstName, ' ', e.LastName) AS EmpName, l.LeaveType, l.StartDate, l.EndDate, l.NoOfDays, l.LeaveStatus, l.Reason, l.AddedDate as AddedDate FROM dbo.LeaveDetailsTbl l LEFT JOIN dbo.EmployeeDetailsTbl e ON l.EmpId = e.EmpId WHERE l.LeaveStatus = 'Approved' AND l.EmpId = @EmpId";
