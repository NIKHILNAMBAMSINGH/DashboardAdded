<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/LeaveMaster.master" AutoEventWireup="true" CodeFile="LeaveStatus.aspx.cs" Inherits="Employee_LeaveStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <table class="auto-style1" style="vertical-align: top;">
        <tr>
            <td style="vertical-align: top" >
                <table class="auto-style1" style="height: 350px">
                    <tr>
   ...
   <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" DataKeyNames="LeaveId" 
        AllowPaging="True" PageSize="3" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" EmptyDataText="No data found" ShowHeaderWhenEmpty="true"> 
   <Columns>
