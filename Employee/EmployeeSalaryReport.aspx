<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/EmployeeSalaryMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeSalaryReport.aspx.cs" Inherits="Employee_EmployeeSalaryReport" %>
            ...
            <td style="vertical-align: top">
             <div class="conatiner">
                 <div class="Year-Month">
                       <asp:Label ID="LabelYear" runat="server" CssClass="label-space" Text="Year :"></asp:Label>
                       <asp:DropDownList ID="DropDownListForYears" runat="server" AutoPostBack="true">
                        <asp:ListItem Value="">Select Year</asp:ListItem>
       
                  </asp:DropDownList>

                <asp:Label ID="LabelMonth" runat="server" Class="label-space" Text="Month :"></asp:Label>
                     <asp:DropDownList ID="DropDownListForMonths" runat="server" AutoPostBack = "true" >
